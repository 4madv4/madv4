...
local function openMobileEditor()
	...
	gearImg.Image = getcustomasset('vaperewrite/assets/new/guisettings.png')
	...
	sbIcon.Image = getcustomasset('vaperewrite/assets/new/search.png')
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		pinicon.Image = getcustomasset('vaperewrite/assets/new/pin.png')
		...
		dotsbutton.MouseButton2Click:Connect(function()
			...
			resetCover.Image = getcustomasset('vaperewrite/assets/new/bindbkg.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('vaperewrite/assets/new/pin.png')
...
function mainapi:CreateCategoryList(categorysettings)
	...
	settings.Image = getcustomasset('vaperewrite/assets/new/customsettings.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('vaperewrite/profiles/'..val..profileId..'.txt') and delfile then
							delfile('vaperewrite/profiles/'..val..profileId..'.txt')
						end
					end
				else
...
function mainapi:CreateSearch()
	...
	searchicon.Image = getcustomasset('vaperewrite/assets/new/search.png')
	...
	legiticon.Image = getcustomasset('vaperewrite/assets/new/legit.png')
...
function mainapi:CreateLegit()
	...
	icon.BackgroundTransparency = 1
	icon.Image = getcustomasset('vaperewrite/assets/new/legittab.png')
	icon.ImageColor3 = uipallet.Text
	icon.Parent = window
	local close = addCloseButton(window)
	local children = Instance.new('ScrollingFrame')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getcustomasset('vaperewrite/assets/new/notification.png')
		...
		iconshadow.Image = getcustomasset('vaperewrite/assets/new/'..(type or 'info')..'.png')
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('vaperewrite/profiles/'..game.GameId..'.gui.txt') then
		guidata = loadJson('vaperewrite/profiles/'..game.GameId..'.gui.txt')
		if not guidata then
			guidata = {Categories = {}}
	...
	if isfile('vaperewrite/profiles/'..self.Profile..profileId..'.txt') then
		local savedata = loadJson('vaperewrite/profiles/'..self.Profile..profileId..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('vaperewrite/assets/new/vape.png')
		image.Parent = button
...
function mainapi:Save(newprofile)
	...
	writefile('vaperewrite/profiles/'..game.GameId..'.gui.txt', httpService:JSONEncode(guidata))
	writefile('vaperewrite/profiles/'..self.Profile..profileId..'.txt', httpService:JSONEncode(savedata))
end
...
mainapi:CreateCategory({
	Name = 'Favorites',
	Icon = getcustomasset('vaperewrite/assets/new/pin.png'),
	Size = UDim2.fromOffset(15, 15)
})

mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('vaperewrite/assets/new/combaticon.png'),
	Size = UDim2.fromOffset(13, 14)
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('vaperewrite/assets/new/blatanticon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('vaperewrite/assets/new/rendericon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Legit',
	Icon = getcustomasset('vaperewrite/assets/new/legit.png'),
	Size = UDim2.fromOffset(24,16),
	Position = UDim2.fromOffset(10,13)
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('vaperewrite/assets/new/utilityicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('vaperewrite/assets/new/worldicon.png'),
	Size = UDim2.fromOffset(14, 14)
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('vaperewrite/assets/new/inventoryicon.png'),
	Size = UDim2.fromOffset(15, 14)
})
mainapi:CreateCategory({
	Name = 'Minigames',
...
mainapi:CreateCategory({
	Name = 'Kits',
	Icon = getcustomasset('vaperewrite/assets/new/vape.png'),
	Size = UDim2.fromOffset(20, 18)
})
mainapi:CreateCategory({
	Name = 'BoostFPS',
	Icon = getcustomasset('vaperewrite/assets/new/edit.png'),
	Size = UDim2.fromOffset(20, 18)
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('vaperewrite/assets/new/friendstab.png'),
...
local profilesCategory = mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('vaperewrite/assets/new/profilesicon.png'),
...
local function getPremadeProfiles()
	...
	for _, file in pairs(listfiles('vaperewrite/profiles/premade')) do
...
premadeIcon.Image = getcustomasset('vaperewrite/assets/new/profilesicon.png')
...
local function showPreview(profileName)
	...
	local premadeFile = 'vaperewrite/profiles/premade/'..profileName..mainapi.Place..'.txt'
...
local function refreshPremadeWindow()
	...
	if #premades == 0 then
		...
		emptyIcon.Image = getcustomasset('vaperewrite/assets/new/profilesicon.png')
	...
	for i, profileName in ipairs(premades) do
		...
		configIcon.Image = getcustomasset('vaperewrite/assets/new/profilesicon.png')
		...
		loadButton.MouseButton1Click:Connect(function()
			...
			if isfile(premadeFile) then
				...
				if isfile('vaperewrite/profiles/'..profileName..profileId..'.txt') and delfile then
					pcall(function() delfile('vaperewrite/profiles/'..profileName..profileId..'.txt') end)
				end
				
				local premadeData = readfile(premadeFile)
				
				writefile('vaperewrite/profiles/'..newProfileName..profileId..'.txt', premadeData)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('vaperewrite/profiles/'..mainapi.Profile..profileId..'.txt') and delfile then
			delfile('vaperewrite/profiles/'..mainapi.Profile..profileId..'.txt')
		end
		shared.vapereload = true
		if shared.VapeDeveloper then
			loadstring(readfile('vaperewrite/loader.lua'), 'loader')()
		else
			loadstring(game:HttpGet('https://raw.githubusercontent.com/4madv4/madv4/'..readfile('vaperewrite/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
...
guipane:CreateDropdown({
	...
	Function = function(val, mouse)
		if mouse then
			writefile('vaperewrite/profiles/gui.txt', val)
			shared.vapereload = true
			if shared.VapeDeveloper then
				loadstring(readfile('vaperewrite/loader.lua'), 'loader')()
			else
...
VapeLogo.Image = getcustomasset('vaperewrite/assets/new/textvape.png')
...
VapeLogoV4.Image = getcustomasset('vaperewrite/assets/new/textv4.png')
...
targetinfoobj = mainapi:CreateOverlay({
	Name = 'Target Info',
	Icon = getcustomasset('vaperewrite/assets/new/targetinfoicon.png'),
	Size = UDim2.fromOffset(14, 14),
	Position = UDim2.fromOffset(12, 14),
	CategorySize = 240,
	Function = function(callback)
